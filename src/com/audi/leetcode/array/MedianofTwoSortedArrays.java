 ...
 * <p>
 * 本题求中位数，其实和求第k小的数的思路是类似的，只不过这里的k应该根据nums1和nums2的长度计算得到
 * 首先，我们知道求中位数实际上是在找到两个有序数组的第K小的数，其中K是两个数组总元素个数的一半。
 * 假设两个有序数组分别是nums1和nums2，我们可以使用双指针的方法来遍历这两个数组，并找到第K小的数。
 *
 * @author: WangQuanzhou
